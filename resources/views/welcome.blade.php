...
>
  <head>
    ...
    <!-- gridjs css -->
    <link rel="stylesheet" href="{{ asset('template/assets/libs/gridjs/theme/mermaid.min.css') }}">
  ...
  <body>
            ...
            <ul class="navbar-nav" id="navbar-nav">
              ...
              <li class="nav-item">
                ...
                >
                  ...
                  <span data-key="t-apps">Gudang</span>
                </a>
              ...
              <li class="nav-item">
                ...
                >
                  ...
                  <span data-key="t-layouts">Sales</span>
        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                <div class="flex-grow-1">
                  ...
                  <p class="text-muted mb-3">Here's what's happening with your store today.</p>
                </div>
    ...
    <!-- gridjs js -->
    <script src="{{ asset('template/assets/libs/gridjs/gridjs.umd.js') }}"></script>

    <!-- Dashboard init -->
    <script src="{{ asset('template/assets/js/pages/dashboard-job.init.js') }}"></script>
